...
document.getElementById("getFile").onchange = function() {
    ...
    function wordCloud(sourceText) {
        // Convert the source text to lowercase and remove the leading and trailing whitespace
        ...
        // Create an 2D array in which each item is array containing a word and its duplicate count
